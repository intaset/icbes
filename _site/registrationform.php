...
Thank you for registering for ICBES 2016. If you have requested any official letters, please allow up to 5 business days to receive your documents.
...
$your_subject = "Your Registration Details for ICBES'16";

$your_headers = "From: ICBES'16 <" . $my_email . ">";
...
<title>ICBES'16 - Registration Form Filled!</title>
...
<div id="content">
  ...
  <header>
	...
	<div class="cbp-af-inner">
        ...
        <div class="bg">
          <h1>3<sup>rd</sup> International Conference on Biomedical<br>Engineering and Systems (ICBES'16)</h1>
 ...
 <div class="unit unit-s-3-4 unit-m-3-4 unit-l-3-4">
  ...
  <div class="unit unit-s-1 unit-m-1-3-1 unit-l-1-3-1">
    ...
    <div>
      <h2 class="title">1</h2>
      <p class="bold">ICBES 2016:</p>
      <p class="body">ICBES 2016 will  be held in Ottawa, Canada on August 17 - 18, 2016.</p>
    </div>          
    <div>
      <h2 class="title">2</h2>
...
<div class="unit unit-s-1 unit-m-1-4-1 unit-l-1-4-1">
  <div class="unit-spacer content">
	...
	<p class="body">We are looking forward to seeing you at ICBES'16!</p>
  </div>
</div>
...
<footer id="contact">
	...
	<div class="unit-spacer">
	<p class="body">For questions or comments regarding ICBES'16, please fill out the form below:</p>
