...
Thank you for registering for ICBES 2019. If you have requested any official letters, please allow up to 5 business days to receive your documents.

If you are an author, please make sure to send us your final version (.doc or .docx format) and a signed copyright form via email to info@icbes.net. You can find the copyright form here: https://icbes.net/papers. Please note that failing to do so may result in an unsuccessful process of your registration.
...
We are pleased to announce that the ICBES 2019 be held at the Hotel Real Palácio. Additionally, we have collaborated with the hotel to offer our attendees a reduced 
rate on their accommodations! This discounted rate is only valid until May 12, 2019. Please view the booking form here: https://icbes.net/RealPalacioLisbonBookingForm.pdf
...
$your_subject = "Your Registration Details for ICBES'19";

$your_headers = "From: ICBES'19 <" . $my_email . ">";
...
<title>ICBES'19 - Registration Form Filled!</title>
...
<div class="unit unit-s-1 unit-m-1-4-1 unit-l-1-4-1">
  ...
  <p class="body">We are looking forward to seeing you at ICBES'19!</p>
  </div>
</div>
...
<footer id="contact">
  ...
  <div class="unit-spacer">
  <p class="body">For questions or comments regarding ICBES'19, please fill out the form below:</p>
